            ...
            <nav className={`header__content__nav ${menuOpen ? 'isMenu' : ''}` }>
                <ul className='header_list'>
                  ...
                  {isLogged && (
                    <>
                     <li>
                        <NavLink onClick={closeMenu} className={({ isActive }) => `header_link ${isActive ? 'active' : '' }`} to={`/profil/${id}/nouveau-itineraire`}>
                          Créer un itineraire
                        </NavLink>
                      </li>
                      <li>
                        <NavLink onClick={closeMenu} to={`/profil/${id}`}>
                        <p className='pseudo'><GiFullMotorcycleHelmet className='icon'/>{pseudo}</p>
                        </NavLink>
                      </li>

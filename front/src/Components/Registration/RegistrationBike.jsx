...
const RegistrationBike=()=>{
    ...
    <form>
        ...
        <input id="brand" type="text" placeholder='marque de la moto' onChange={(e)=>setBrand(e.target.value)}/>

        <label for="model" >Quel est le modèle de votre moto *</label>
        <input id="model" type="text" placeholder='modèle'onChange={(e)=>setModel(e.target.value)}/>
        ...
        <button onClick={handleOnsubmit} disabled={brand ==="" || model==="" }>valider</button>
    </form>)
}

...
INSERT INTO "itinerary" ("title", "description", "hour", "minute", "highway", "kilometer", "curve", "user_id")
VALUES
('les gorges du Verdon par Vinon', 'Profitez de cet itinéraire pour vous bamader le long du lac de Ste Croix et y découvrir un merveilleux paysage', 1, 30, FALSE, 206, 4, 1),
('le litoral de Cassis', 'Une petite balade le long du litoral, pour profiter du bon air marin', 1, 30, FALSE, 120, 2, 3),
('la corniche des Cévennes', 'au milieu de la verdure cevenole, ce trajet vous permettra de découvrir de jolies routes et de rider entre potes', 2, 0, TRUE, 164, 5, 2),
('abbaye de frigolet', 'magnifique abaye dans les alpilles', 1, 50 , FALSE , 30, 3 , 4),
('stade velodrome', 'un lieu de pelerinage pour les amoureux du ballon rond...', 3, 0 , FALSE , 10, 1 , 5),
('saintes maries de la mer', 'magnifique balade au coeur de la camargue ', 1, 50 , FALSE , 30, 3 , 6),
('frot', 'balade le long du canal', 5, 0, FALSE, 300, 5, 7),
('blamont', 'balade en montagne', 1, 30, TRUE, 80, 5, 8),
('couché de soleil', 'balade en bord de mer', 2, 20,TRUE, 80, 1, 9),
('balade tranquille', 'juste histoire de rider, une balade découverte des environs', 1, 20,TRUE, 80, 1, 9);
...
VALUES
('Le lac de Ste Croix', 'Vue du lac de Ste Croix depuis le point sublime', 'https://lesgorgesduverdon.fr/wp-content/uploads/2021/02/photo-mailingbis.jpg', 2, null, 1),
